...
def send_echo(message):
      ...
      ## Если температура больше 30 ℃, то...
      elif temp > 30:
            answer += "На улице жарко. Можете одевать лёгкую одежду, но не забудьте про головной убор"
      ## Если температура больше 40 ℃, то...
      elif temp >= 40:
            answer += "На улице очень жарко! Настоятельно не рекомендуем Вам выходить из дома. Это может быть опасно для жизни"
